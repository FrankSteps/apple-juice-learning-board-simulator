...
\begin{titlepage}
    ...
    {\large Francisco Passos, Renato Veloso, Arthur Grazzia, Carlos Eduardo}\\[4cm]
    
    {\Large \textbf{Simulador da Placa Didática Apple Juice: Desenvolvimento e Documentação}}\\[4cm]
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/apple-juice.jpeg}
...
\begin{itemize}
    \item STMicroelectronics. \textbf{NE555 Timer Datasheet}. Disponível em: \url{https://www.ti.com}. Acesso em: 22 fev. 2026.

    \item Texas Instruments. \textbf{CD4017B Decade Counter/Divider Datasheet}. Disponível em: \url{https://www.ti.com}. Acesso em: 22 fev. 2026.

    \item Texas Instruments. \textbf{CD4026B Decade Counter/7-Segment Display Driver Datasheet}. Disponível em: \url{https://www.ti.com}. Acesso em: 22 fev. 2026.

    \item \textbf{RAYLIB TECHNOLOGIES}. \textit{Raylib Documentation}. Disponível em: \url{https://www.raylib.com}. Acesso em: 22 fev. 2026.

    \item STROUSTRUP, Bjarne. \textbf{The C++ Programming Language}. 4. ed. Boston: Addison-Wesley, 2013.

    \item STROUSTRUP, Bjarne. \textbf{Programming: Principles and Practice Using C++}. 2. ed. Boston: Addison-Wesley, 2014.
\end{itemize}
